...
namespace ECS
{
	...
	public:
		...
		static ECS::EntityManager* getInstance();
		/// <summary>
		...
		void createEntity(Util::StringAtom entityID, Util::Array<ECS::BaseComponent> components);
		/// <summary>
	...
	private:
		Util::HashTable<Util::StringAtom, ECS::GameEntity*> _entities;
		static ECS::EntityManager* instance;
	};
